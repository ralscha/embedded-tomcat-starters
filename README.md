...
- `tomcat9` for Java EE 8 / `javax.*` applications on Tomcat `9.0.121`
- `tomcat10` for Jakarta EE 10 / `jakarta.*` applications on Tomcat `10.1.59`
- `tomcat11` for Jakarta EE 11 / `jakarta.*` applications on Tomcat `11.0.25`
